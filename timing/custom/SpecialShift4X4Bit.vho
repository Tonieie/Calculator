...
-- Equation(s):
-- \data1~80_combout\ = !\clear~input_o\ & \data0[0]~q\
...
-- Equation(s):
-- \data1~81_combout\ = !\clear~input_o\ & \data0[1]~q\
...
-- Equation(s):
-- \data1~82_combout\ = !\clear~input_o\ & \data0[2]~q\
...
-- Equation(s):
-- \data1~83_combout\ = !\clear~input_o\ & \data0[3]~q\
...
-- Equation(s):
-- \data2~80_combout\ = !\clear~input_o\ & \data1[0]~q\
...
-- Equation(s):
-- \data2~81_combout\ = !\clear~input_o\ & \data1[1]~q\
...
-- Equation(s):
-- \data2~82_combout\ = !\clear~input_o\ & \data1[2]~q\
...
-- Equation(s):
-- \data2~83_combout\ = !\clear~input_o\ & \data1[3]~q\
...
-- Equation(s):
-- \data3~80_combout\ = !\clear~input_o\ & \data2[0]~q\
...
-- Equation(s):
-- \data3~81_combout\ = !\clear~input_o\ & \data2[1]~q\
...
-- Equation(s):
-- \data3~82_combout\ = !\clear~input_o\ & \data2[2]~q\
...
-- Equation(s):
-- \data3~83_combout\ = !\clear~input_o\ & \data2[3]~q\
