...
SIGNAL \BinaryOut[0]~output_o\ : std_logic;
SIGNAL \BinaryOut[1]~output_o\ : std_logic;
SIGNAL \BinaryOut[2]~output_o\ : std_logic;
SIGNAL \BinaryOut[3]~output_o\ : std_logic;
SIGNAL \BinaryOut[4]~output_o\ : std_logic;
SIGNAL \BinaryOut[5]~output_o\ : std_logic;
SIGNAL \BinaryOut[6]~output_o\ : std_logic;
SIGNAL \BinaryOut[7]~output_o\ : std_logic;
SIGNAL \BinaryOut[8]~output_o\ : std_logic;
SIGNAL \BinaryOut[9]~output_o\ : std_logic;
SIGNAL \BinaryOut[10]~output_o\ : std_logic;
SIGNAL \BinaryOut[11]~output_o\ : std_logic;
SIGNAL \BinaryOut[12]~output_o\ : std_logic;
SIGNAL \BinaryOut[13]~output_o\ : std_logic;
SIGNAL \BinaryOut[14]~output_o\ : std_logic;
SIGNAL \BinaryOut[15]~output_o\ : std_logic;
...
ww_BinaryOut(0) <= \BinaryOut[0]~output_o\;

ww_BinaryOut(1) <= \BinaryOut[1]~output_o\;

ww_BinaryOut(2) <= \BinaryOut[2]~output_o\;

ww_BinaryOut(3) <= \BinaryOut[3]~output_o\;

ww_BinaryOut(4) <= \BinaryOut[4]~output_o\;

ww_BinaryOut(5) <= \BinaryOut[5]~output_o\;

ww_BinaryOut(6) <= \BinaryOut[6]~output_o\;

ww_BinaryOut(7) <= \BinaryOut[7]~output_o\;

ww_BinaryOut(8) <= \BinaryOut[8]~output_o\;

ww_BinaryOut(9) <= \BinaryOut[9]~output_o\;

ww_BinaryOut(10) <= \BinaryOut[10]~output_o\;

ww_BinaryOut(11) <= \BinaryOut[11]~output_o\;

ww_BinaryOut(12) <= \BinaryOut[12]~output_o\;

ww_BinaryOut(13) <= \BinaryOut[13]~output_o\;

ww_BinaryOut(14) <= \BinaryOut[14]~output_o\;

ww_BinaryOut(15) <= \BinaryOut[15]~output_o\;
END structure;
